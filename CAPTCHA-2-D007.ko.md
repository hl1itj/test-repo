...
모든 프로젝트 설계가 아래와 같은 모든 항목을 포함해야하는 것이나, 프로젝트 문제에 대한 명확한 설명, 기술적 사양, 구현에 적용될 제약조건들, 결과물의 정의와 평가 방법, 프로젝트를 수행할 때 도움이 되는 자료들, 프로젝트 설명과 함께 제공되는 데이터나, 프로그램, 개발 환경들에 관한 소개가 필요함
```
```
파일명 규칙 :
