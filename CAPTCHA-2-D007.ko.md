...
1. 보너스 문제의 차량 번호판은 "12가3456"와 같은 2자리+한글+4자리 형식의 번호판으로 제한. 번호판 이미지는 실물 번호판의 비율로 흰색, 초록색, 노랑색으로 생성하고 인위적으로 잡음을 섞고, 마름모 모양의 사각형으로 변형한 것을 주로 사용하고 실제 번호판 이미지 100개 이상을 수집하여 학습에 사용.
